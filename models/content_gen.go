...
// DecodeMsg implements msgp.Decodable
func (z *DocumentContent) DecodeMsg(dc *msgp.Reader) (err error) {
	{
		var zb0001 []byte
		...
		(*z) = DocumentContent(zb0001)
	}
	return
}

// EncodeMsg implements msgp.Encodable
func (z DocumentContent) EncodeMsg(en *msgp.Writer) (err error) {
...
// MarshalMsg implements msgp.Marshaler
func (z DocumentContent) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *DocumentContent) UnmarshalMsg(bts []byte) (o []byte, err error) {
	{
		var zb0001 []byte
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z DocumentContent) Msgsize() (s int) {
